...
e1 = EliminationType.create!(type: "Pratinho de planta")
e2 = EliminationType.create!(type: "Pneu")
e3 = EliminationType.create!(type: "Lixo (recipientes inutilizados)")
e4 = EliminationType.create!(type: "Pequenos Recipientes utilizáveis Garrafas de vidro, vasos, baldes, tigela de água de cachorro")
e5 = EliminationType.create!(type: "Grandes Recipientes Utilizáveis Tonéis, outras depósitos de água, pias, galões d’água.")
e6 = EliminationType.create!(type: "Calha")
e7 = EliminationType.create!(type: "Registros abertos")
e8 = EliminationType.create!(type: "Laje e terraços com água")
e9 = EliminationType.create!(type: "Piscinas")
e10 = EliminationType.create!(type: "Poças d’água na rua")
e11 = EliminationType.create!(type: "Ralos")
e12 = EliminationType.create!(type: "Plantas aquáticas em vaso de água")


# puts "Creating elimination methods"
m1 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m2 = EliminationMethod.create!(method: "Prato removido (ou seja, não mais utilizado)" points: 200)
m3 = EliminationMethod.create!(method: "Coloque areia" points: 100)
m4 = EliminationMethod.create!(method: "Retire a água e esfregue para remover possíveis ovos (uma vez por semana)." points: 50)
m5 = EliminationMethod.create!(method: "Desfaça-se do pneu (entregue ao serviço de limpeza)" points: 50)
m6 = EliminationMethod.create!(method: "Arranje um uso alternativo para o pneu: preencha com terra e faça uma horta; preencha com areia, terra e cimento e utilize como degrau." points: 450)
m7 = EliminationMethod.create!(method: "Transferir o pneu sem água para um local coberto e seco." points: 100)
m8 = EliminationMethod.create!(method: "Cubra o pneu com algo que não se transforme em um foco potencial do mosquito." points: 100)
m9 = EliminationMethod.create!(method: "Jogá-los em uma lixeira bem tampada." points: 0)
m10 = EliminationMethod.create!(method: "Organize um mutirão de limpeza na vizinhança (coordenado pelos Agentes de Vigilância Sanitária) OBS: em locais onde não há atuação dos garis comunitários." points: 450)
m11 = EliminationMethod.create!(method: "Participe de um mutirão de limpeza na vizinhança (coordenado pelos Agentes de Vigilância Sanitária) OBS: em locais onde não há atuação dos garis comunitários." points: 350)
m12 = EliminationMethod.create!(method: "Remova a água e esfregue uma vez por semana; ou, no caso de bebedouros de animais e aves, trocar a água e limpar diariamente." points: 50)
m13 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m14 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m15 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m16 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m17 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m18 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m19 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m20 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m21 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m22 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m23 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m24 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m25 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m26 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m27 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m28 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m29 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m30 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
m31 = EliminationMethod.create!(method: "Elimine fazendo furos no pratinho" points: 200)
