...
describe DescriptionsController do
  ...
  let(:valid_attributes) { { "time" => "2014-03-12 15:52:59" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved description as @description" do
        ...
        post :create, {:description => { "time" => "invalid value" }}, valid_session
        assigns(:description).should be_a_new(Description)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested description" do
        ...
        Description.any_instance.should_receive(:update_attributes).with({ "time" => "2014-03-12 15:52:59" })
        put :update, {:id => description.to_param, :description => { "time" => "2014-03-12 15:52:59" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the description as @description" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Description.any_instance.stub(:save).and_return(false)
        put :update, {:id => description.to_param, :description => { "time" => "invalid value" }}, valid_session
        assigns(:description).should eq(description)
      end
